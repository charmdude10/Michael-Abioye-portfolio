...
const projects = [
  {
    ...
    description:
      "Web-based platform that allows users to search, book, and manage flights from various airpot destination to another, providing a convenient and efficient solution for your trip.",
    tags: [
      {
        name: "react",
